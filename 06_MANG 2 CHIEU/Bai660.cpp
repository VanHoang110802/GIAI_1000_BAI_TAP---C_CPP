Nhập vào mảng 2 chiều các số nguyên, xuất ra mảng vừa nhập và đi xử lý các yêu cầu sau:

----------- BÀI TẬP CƠ BẢN ------------

1/ Liệt kê các số chẵn có trong mảng.
2/ Liệt kê các số nguyên tố có trong mảng.
3/ Liệt kê các số hoàn thiện có trong mảng.
...
16/ Sắp xếp mảng giảm dần theo từng cột.
17/ Sắp xếp mảng tăng dần theo chiều từ trên xuống dưới, từ trái qua phải.

-------------- BÀI TẬP NÂNG CAO --------------
18/ Liệt kê các cột có nhiều "chữ số" nhất trong ma trận.
19/ Cho ma trận các số nguyên A(m x n). Hãy xây dựng ma trận B(m x n) từ ma trận A sao cho B[i][j] = lớn nhất của dòng i và cột j trong ma trận A.
20/ Đếm số lượng giá trị "hoàng hậu" trên ma trận. Một phần tử được gọi là hoàng hậu khi nó lớn nhất trên dòng, trên cột và hai đường chéo đi qua nó.

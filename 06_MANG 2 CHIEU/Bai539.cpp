Đếm số lượng giá trị “Hoàng Hậu” trên ma trận. Một phần tử được gọi là Hoàng Hậu khi nó lớn nhất trên dòng, trên cột và hai đường chéo
đi qua nó.
/*
...
int main()
{
	...
	printf("\nSo luong phan tu hoang hau la: %d", dem);
	return 0;
}

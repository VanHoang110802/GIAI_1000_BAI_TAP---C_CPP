Tìm giá trị nhỏ nhất trong ma trận tam giác dưới.
...
int main()
{
	...
	printf("\nGia tri nho nhat ma tran tam giac duoi duong cheo chinh la: %d", Min);
	int Min2 = TimGiaTriNhoNhatMaTranTamGiacDuoiDuongCheoPhu(a, n);
	printf("\nGia tri nho nhat ma tran tam giac duoi duong cheo phu la: %d", Min2);
	return 0;
}

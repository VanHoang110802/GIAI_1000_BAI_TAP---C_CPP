Tính tổng các phần tử cực trị trong ma trận các số thực. Một phần tử được gọi là cực trị khi nó lớn hơn các phần tử xung quanh hoặc nhỏ
...
*/
/*
Đầu tiên đặt check =1 tức là mặc định giá trị ô a[d][c] là cực đại,
nếu như 1 trong các ô xung quanh ô a[d][c] này có giá trị lớn hơn nó (a[d][c]<=a[d+i][c+j]) thì đặt check = 0 tức là nó ko phải điểm cực đại
...
int main()
{
	...
	printf("\nTong cac phan tu cuc tri trong ma tran la: %.3f", tong);
	return 0;
}

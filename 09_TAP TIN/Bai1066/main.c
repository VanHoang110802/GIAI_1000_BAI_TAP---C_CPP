/* Viết chương trình nhập 1 chuỗi bất kì vào file rồi đếm kí tự của chuỗi đó 
(Không đọc số từ 1 - 9 và các kí tự lạ )
*/
#include <iostream>
#include <string>
#include <fstream>
...
void GhiFile(ofstream& FileOut, int SoLuong)
{
	...
	//if (FileOut != NULL)
	{
		FileOut << "So luong ky tu la chu cai la: " << SoLuong - 1;
	}

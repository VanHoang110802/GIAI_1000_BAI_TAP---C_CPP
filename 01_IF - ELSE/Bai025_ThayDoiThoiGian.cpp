Hoà vừa tạo ra 1 hệ điều hành mới có tên gọi là hoafOS. Nhưng hệ điều hành của cậu ta chưa được hoàn thiện và mắc một số lỗi về thời gian. Giờ đây khi muốn thay đôi thời
gian, Hòa phải nhập theo cú pháp:

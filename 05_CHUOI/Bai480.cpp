...
sau đó ta sẽ đi duyệt cả 2 chuỗi, khởi tạo biến check = 0, xét xem nếu phần tử của chuỗi này giống chuỗi kia hay không( kiểm tra xem phần tử đã nhập đó tồn tại hay chưa?), 

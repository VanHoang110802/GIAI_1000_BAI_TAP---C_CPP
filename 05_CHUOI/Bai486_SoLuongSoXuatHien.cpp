Cho xâu ký tự s chỉ gồm các chữ cái latin và chữ số. Ta gọi một số trong xâu s là một dãy các ký tự số liên tiếp (có thể bắt đầu bằng ký tự số '0'). Hãy đếm số lượng
số xuất hiện trong xâu s.
